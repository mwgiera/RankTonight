export type Language = "en" | "de" | "pl" | "uk";
...
const translations: Record<Language, TranslationKeys> = {
  ...
  uk: {
    ...
    now: {
      ...
      recommendation: "Рекомендована платформа для максимального заробітку",
      alternativeOptions: "Альтернативні варіанти",
      demand: "Попит",
      friction: "Опір",
      incentive: "Стимул",
      reliable: "Надійний",
      ...
      weak: "Слабка",
      basedOn: "На основі",
      changeZone: "Змінити зону",
      scoreBreakdown: "Розбивка балів",
      selectZone: "Вибрати зону",
      opportunityScore: "Оцінка можливості",
      profitability: "Прибутковість",
      proxyModeLabel: "Проксі-модель (пріоритети попиту/опору). Не базується на історії заробітку.",
      personalModeLabel: "На основі ваших записаних заробітків",
      noDataYet: "Ще немає даних",
      needMoreRecords: "Потрібно більше записів для особистого режиму",
    },
    zones: {
      title: "Зони",
      selectZone: "Вибрати зону",
      currentZone: "Поточна зона",
      behaviorBias: "Поведінка",
      all: "Усі",
      airport: "Аеропорт",
      center: "Центр міста",
      residential: "Житловий район",
      noZonesFound: "Зони не знайдено",
    },
    log: {
      title: "Журнал заробітку",
      addEarnings: "Додати заробіток",
      platform: "Платформа",
      amount: "Сума",
      duration: "Тривалість",
      minutes: "хв",
      ...
      noLogs: "Немає записів заробітку",
      noLogsDesc: "Почніть записувати свої поїздки, щоб відстежувати продуктивність та покращувати рекомендації.",
      logFirstRide: "Записати першу поїздку",
      delete: "Видалити",
      totalEarnings: "Загальний заробіток",
      hoursLogged: "Записаних годин",
      avgRate: "Середня ставка",
    },
    profile: {
      title: "Профіль",
      ...
      sensitivity: "Чутливість моделі",
      sensitivityDesc: "Налаштуйте, наскільки агресивно модель розрізняє платформи",
      ...
      clearDataSuccess: "Всі дані видалено",
      designedBy: "Дизайн",
      developedBy: "Розробка",
      license: "Всі права захищені | Ліцензія MIT",
      scoringMode: "Режим оцінювання",
      pilotMode: "Пілотний режим",
      personalMode: "Особистий режим",
      pilotModeDesc: "Використовує ринкові еталони до 5+ поїздок",
      personalModeDesc: "Використовує ваші записані заробітки",
    },
    receipts: {
      title: "Чеки",
      pasteReceipt: "Вставити текст чеку",
      selectPlatform: "Вибрати платформу",
      parseReceipt: "Аналізувати чек",
      parsedPreview: "Попередній перегляд",
      date: "Дата",
      time: "Час",
      amount: "Сума",
      duration: "Тривалість",
      unknown: "Невідомо",
      revPerHour: "Дохід/год.",
      saveToLog: "Зберегти до журналу",
      editFields: "Редагувати поля",
      parseError: "Не вдалося проаналізувати чек",
      noReceiptText: "Вставте текст чеку для аналізу",
      exportCsv: "Експорт CSV",
      parsedReceipts: "Проаналізовані чеки",
      importToLog: "Імпорт до журналу",
      perTrip: "за поїздку",
      durationMissing: "тривалість відсутня",
    },
    context: {
      weekendMode: "Режим вихідних",
      weekdayMode: "Режим будніх",
      earlyMorning: "Ранній ранок (05-07)",
      morningRush: "Ранковий пік (07-10)",
      midday: "Полудень (10-14)",
      afternoon: "Післяобід (14-17)",
      eveningRush: "Вечірній пік (17-20)",
      lateNight: "Пізня ніч (20-02)",
      overnight: "Ніч (02-05)",
    },
    common: {
      confirm: "Підтвердити",
